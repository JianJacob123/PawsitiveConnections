<?php
    ...
    if (mysqli_connect_error()) {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'GET') {
            $sql = "SELECT list_id, fname, lname, address, pet_name, age, breed, animal_type, images_url, is_approved, list_status FROM petlisting
INNER JOIN pets
on pets.pet_id = petlisting.pet_id
INNER JOIN users
on users.user_id = petlisting.user_id
INNER JOIN images
on pets.pet_id = images.pet_id WHERE is_approved = 'approved' AND list_status = 'not adopted';";
